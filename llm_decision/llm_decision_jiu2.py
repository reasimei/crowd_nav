...
class LLMDecisionMaker:
    ...
    Please analyze the situation and provide navigation decisions for all robots in the following JSON format:
    {{
        ...
        "robots_decisions": [
            {{
                ...
                "reasoning": "<explanation_for_this_robot>"
            }},
            ...
        ],
    ...
    Consider interactions between all robots and humans, and provide coordinated movement suggestions.
    """
