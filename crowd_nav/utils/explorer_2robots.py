...
class Explorer(object):
    ...
    def run_k_episodes(self, k, phase, update_memory=False, imitation_learning=False, episode=None,
        ...
        for i in range(k):
            ...
            rewards = []
            while not done:
                action1 = self.robot1.act(ob)
                action2 = self.robot2.act(ob)
            ...
            cumulative_rewards.append(sum([pow(self.gamma, t * (self.robot1.time_step + self.robot2.time_step) * (self.robot1.v_pref + self.robot2.v_pref))
