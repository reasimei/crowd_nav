...
class MultiHumanRL(CADRL):
    ...
    def predict(self, state):
        ...
        # Combine self state and other robot state
        combined_self_state = state.self_state + state.other_robot_state
        # Transform state
        state_tensor = torch.cat([torch.Tensor([combined_self_state + human_state]).to(self.device)
