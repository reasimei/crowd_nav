...
class JointState(object):
    def __init__(self, self_state, other_robot_states, human_states):
        ...
        if human_states is None:
            human_states = []
        elif not isinstance(human_states, list):
    ...
    def get_human_num(self):
        return len(self.human_states)
        
    def get_robot_num(self):
        return len(self.other_robot_states)
        
    def __str__(self):
        return f"JointState with {len(self.human_states)} humans and {len(self.other_robot_states)} other robots"
